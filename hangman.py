...
class HangmanSetup:
    def __init__(self, master):
        ...
        self.label = tk.Label(self.master, text="Select Difficulty Level:", font=("Helvetica", 14), bg="white")
        self.label.pack()

        self.easy_button = tk.Radiobutton(self.master, text="Easy", variable=self.difficulty, value="Easy", font=("Helvetica", 12), bg="white")
        self.easy_button.pack()

        self.medium_button = tk.Radiobutton(self.master, text="Medium", variable=self.difficulty, value="Medium", font=("Helvetica", 12), bg="white")
        self.medium_button.pack()

        self.hard_button = tk.Radiobutton(self.master, text="Hard", variable=self.difficulty, value="Hard", font=("Helvetica", 12), bg="white")
    ...
    def start_game(self):
        ...
        if difficulty_level:
            ...
            messagebox.showinfo("Hangman Setup", "Please select a difficulty level.")
...
class HangmanGame:
    def __init__(self, master, difficulty):
        ...
        self.word_label = tk.Label(self.master, text="", font=("Helvetica", 24), bg="white")
        self.word_label.pack()

        self.input_label = tk.Label(self.master, text="Enter a letter:", font=("Helvetica", 14), bg="white")
